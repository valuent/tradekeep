  ...
  return (
    <>
      <div
        ...
        className="fixed left-0 right-0 top-full z-50 m-auto h-[80vh] overflow-y-auto rounded-xl bg-base-200 transition-all duration-100 ease-in-out md:w-9/12 lg:w-8/12"
      >
        <button
          onClick={() => {
            closeInfoTrade();
        ...
        <div className="card-body h-max items-center text-center">
          ...
          {currentStrat && tradeKey?.[currentStrat] && (
            <>
              ...
              {currentStrat && tradeKey?.[currentStrat]?.detail?.noOfTrade && (
                <div className="stats mt-3 min-h-max shadow">
                  <div className="stat ">
